...
$route['portal/payment-details']['GET'] = 'Dashboard/paymentDetails';
$route['portal/po-agreements']['GET'] = 'Dashboard/agreements';
$route['portal/po-item-warranty']['GET'] = 'Dashboard/warranty';
$route['portal/warranty-expired-items']['GET'] = 'Dashboard/expired';
$route['portal/po-ldc-details']['GET'] = 'Dashboard/ldc';
$route['portal/po-dds-list']['GET'] = 'Dashboard/dd';
...
$route['portal/updatePO/(:any)']['POST'] = 'Purchase_Orders/updatePO/$1';
$route['portal/updatePOItem/(:any)']['POST'] = 'Purchase_Orders/updatePOItem/$1';
$route['portal/view-po/(:any)']['GET'] = 'Purchase_Orders/viewPODetails/$1';

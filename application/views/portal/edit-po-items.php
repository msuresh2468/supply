                        ...
                        <div class="row purchase_order_form">
                            ...
                            <div class="col-md-4 mt-lg-3">
                                <div class="d-flex align-items-end supply_status">
                                    ...
                                    <label class="ms-3"><input type="radio" name="supply_status" id="supply_status_no" value="Not Supplied" <?php if ($PO_Item->supply_status == 'Not Supplied') { ?> checked <?php } else {
                                                                                                                                                                                                                echo 'disabled';
                                                                                                                                                                                                            } ?> class="supply_status_yes flex-1 input_style"> No</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3 d-flex align-items-end">
